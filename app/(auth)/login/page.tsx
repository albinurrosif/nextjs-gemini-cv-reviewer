    ...
    <main className="flex min-h-[calc(100vh-80px)] w-full items-center justify-center bg-background p-4">
      <Card className="w-full max-w-md shadow-lg border-border">
        ...
        <CardContent>
          ...
          {/* --- TOMBOL GOOGLE (Tampilan Saja Dulu) --- */}
          <div className="mt-6">
            ...
            <Button variant="secondary" className="w-full mt-4 gap-2" type="button">
        ...
        <CardFooter className="flex justify-center border-t p-4 text-center">
          <p className="text-xs text-muted-foreground">Dengan mendaftar, Anda menyetujui Ketentuan Layanan dan Kebijakan Privasi kami.</p>
        </CardFooter>
      </Card>
    </main>
  );
