...
export default function GeneralAnalysisResult({ data }: { data: EvaluationResult }) {
  ...
  const markdownComponents = {
    h1: ({ node, ...props }: any) => <h1 className="text-2xl font-bold mt-4 mb-2 text-primary" {...props} />,
    h2: ({ node, ...props }: any) => <h2 className="text-xl font-bold mt-4 mb-2 text-primary/80" {...props} />,
